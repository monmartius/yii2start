...
<!--                <img src="/images/product-details/1.jpg" alt="">-->
                <h2><?php
                    echo Url::to("@web/images/{$product->img}") ?></h2>
                <h3>ZOOM</h3>
            </div>
        ...
        <div class="col-sm-7">
            <p class="product-information"><!--/product-information-->
<!--                <img src="/images/product-details/new.jpg" class="newarrival" alt="">-->
                <h3>NEW: <?= $product->new?></h3>
                <h2><?= $product->name?></h2>
                ...
                <span>
                    ...
                    <form action="/cart/add" method = "get">
                        ...
                        <button type="sumbit" class="btn btn-default cart btn-add-to-cart">
                ...
                <p>
                    <b>Brand:</b>
                    <?php // debugd(Url::to([ 'category/view', 'id' => $product->category->id] )) ?>
